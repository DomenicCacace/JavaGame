...
public final class Noise {
   ...
   */
   ...
   static {
       //Hey there! 
       //Fun Fact: I created new methods specifically for this purpose. 
       //Easier than copy-pasting a lot of code.
       SettingsHandler loader = new SettingsHandler();
       loader.nextLine(4);
       seed = loader.loadSeed();
       loader.close();
       loader = null;
       
      //experimental: initiliaze this in Game constructor so that the seed is always fresh. No restart required.
      //This was a success 
      //init();
   }
